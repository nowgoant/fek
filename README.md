...
插件：
 ...
 - 代码格式工具[Tag](https://packagecontrol.io/packages/Tag)只用于html;[HTML-CSS-JS Prettify](https://packagecontrol.io/packages/HTML-CSS-JS%20Prettify)见闻知意了，依赖于Node
...
**国外篇**
 ...
 - [Yeoman](http://yeoman.io/)：现代WebApp脚手架工具，带有很多generator生成器，比如：generator-webapp,generator-mobile移动优先，[视频教程](http://www.imooc.com/learn/30)[老湿](http://www.imooc.com/learn/30)很牛
 ...
 - [Gulp](http://gulpjs.com/)：Grunt竞争对手，Grunt的插件职责不单一，Gulp针对有个改进
